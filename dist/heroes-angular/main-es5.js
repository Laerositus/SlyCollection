...
var routes = [
    ...
    {
        path: 'heroes',
        loadChildren: function () { return __webpack_require__.e(/*! import() | heroes-heroes-module */ "heroes-heroes-module").then(__webpack_require__.bind(null, /*! ./heroes/heroes.module */ "./src/app/heroes/heroes.module.ts")).then(function (m) { return m.HeroesModule; }); }
    },
    {
        path: 'villains',
        loadChildren: function () { return __webpack_require__.e(/*! import() | villains-villains-module */ "villains-villains-module").then(__webpack_require__.bind(null, /*! ./villains/villains.module */ "./src/app/villains/villains.module.ts")).then(function (m) { return m.VillainsModule; }); }
    },
...
var HeaderBarBrandComponent = /** @class */ (function () {
    function HeaderBarBrandComponent() {
    }
...
var HeaderBarLinksComponent = /** @class */ (function () {
    function HeaderBarLinksComponent() {
    }
    ...
    return HeaderBarLinksComponent;
}());
...
var ButtonFooterComponent = /** @class */ (function () {
    function ButtonFooterComponent() {
        this.clicked = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ButtonFooterComponent.prototype.ngOnInit = function () { };
    ButtonFooterComponent.prototype.handleClick = function () {
...
var ListHeaderComponent = /** @class */ (function () {
    ...
    ListHeaderComponent.prototype.handleAdd = function () {
        this.add.emit();
    };
    ListHeaderComponent.prototype.handleRefresh = function () {
        this.refresh.emit();
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
var root = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].API;
...
/* harmony import */ var _ngrx_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ngrx/data */ "./node_modules/@ngrx/data/fesm5/data.js");
